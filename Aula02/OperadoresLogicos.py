...
print(texto.startswith('um')) # o que é feito por baixo dos panos ==> 'um' and 'um' - ele retorna True
...
#AND//E
print((5 >= 5) and (4 > 3)) #True and True ==> True (só retorna true se ambas as preposições forem verdadeiras)
