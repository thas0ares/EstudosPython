...
print(texto[0:5]) #pega do 0 até o 4, lembrando que o último número não está incluido)
...
print(type(texto.endswith('t'))) # retorna class 'bool' -> tipo booleano o True ou False... são utilizados com letras maiúsculas

print(texto.split()) # utilizado em lista, ele consegue separar minha frase em unidades individuais de txt em por alguma caractere especial, nesse caso ele esta utilizando o espaço
texto_separo_por_virgulas = 'nome,idade,sexo,cpf,uf'
print(texto_separo_por_virgulas.split(',')) # retorna ['nome', 'idade', 'sexo', 'cpf', 'uf'] esse tipo de dado é uma lista, uma outra forma de interpretação de txt
